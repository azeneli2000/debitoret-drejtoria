...
export class MesuesiLendaComponent implements OnInit {
  ...
  constructor(private db:AngularFireDatabase, private route : ActivatedRoute, private mesuesiZgjedhur : MesuesiZgjedhurService,private router : Router,private mz:MesuesiZgjedhurService) { }
...
getLendet(mesZgjedhur){
  ...
  this.mesuesiList = this.db.list(localStorage.getItem('2020-2021') +'/Mesuesit');
...
console.log(this.mesuesiId);
   ...
   this.getLendet(idMesuesi.toString()).subscribe(
    list => {
